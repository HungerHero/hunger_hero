      ...
      <div id="popup-modal" className="modal-overlay" tabIndex="-1">
        <div className="modal-content">
          <div className="modal-body">
            ...
            <h3 className="modal-title">Helping to get food to those in need takes both a Distributor and a Receiver. <br /> A Distributor role is designated for those who have excess food that could go to help many in need. <br /> A Receiver role is meant for those who prepare the food directly to the people in need and are in need of donated food to work with. </h3>
